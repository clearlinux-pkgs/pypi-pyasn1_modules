...
Source0  : https://files.pythonhosted.org/packages/1d/67/6afbf0d507f73c32d21084a79946bfcfca5fbc62a72057e9c23797a737c9/pyasn1_modules-0.4.1.tar.gz
...
%prep
%setup -q -n pyasn1_modules-0.4.1
cd %{_builddir}/pyasn1_modules-0.4.1
pushd ..
cp -a pyasn1_modules-0.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726062947
