...
Source0  : https://files.pythonhosted.org/packages/f7/00/e7bd1dec10667e3f2be602686537969a7ac92b0a7c5165be2e5875dc3971/pyasn1_modules-0.4.0.tar.gz
...
%prep
%setup -q -n pyasn1_modules-0.4.0
cd %{_builddir}/pyasn1_modules-0.4.0
pushd ..
cp -a pyasn1_modules-0.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711505747
